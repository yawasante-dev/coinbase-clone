      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="mt-4 rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-3">
          <p className="text-sm text-yellow-800">
            ⚠️ <span className="font-semibold">Demo app</span> — do not use your real password or personal information. This is a student project not affiliated with Coinbase.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <Button type="submit" fullWidth className="rounded-lg" disabled={loading}>
        ...
        <div className="mt-8 pb-12 text-center text-sm text-muted-foreground">
